  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-20">
      ...
      <Tabs defaultValue="packages" className="w-full">
        <TabsList className="w-full max-w-2xl grid grid-cols-2 sm:grid-cols-4 mb-8 [&>button]:min-h-[44px]">
          ...
          <Card className="glass-card border-border/50">
            ...
            <CardContent className="space-y-6">
              <div className="flex gap-4">
                ...
                />
                <Button onClick={handleAddPackage} className="bg-primary hover:bg-primary/90 min-h-[44px]" data-testid="button-add-package">
                ...
                {servicePackages?.map((pkg) => (
                  <div key={pkg.id} className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border/50 group hover:border-primary/30 transition-colors" data-testid={`package-${pkg.id}`}>
                    ...
                    <Button 
                      ...
                      className="min-h-[44px] min-w-[44px] text-muted-foreground hover:text-destructive opacity-50 group-hover:opacity-100"
