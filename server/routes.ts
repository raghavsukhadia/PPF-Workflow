...
// Require user role (use after verifyAuth). Returns 403 if role does not match.
...
export async function registerRoutes(
  ...
  router.post("/packages", verifyAuth, requireRole("Admin"), async (req, res) => {
    try {
  ...
  router.delete("/packages/:id", verifyAuth, requireRole("Admin"), async (req, res) => {
    try {
  ...
  router.post("/ppf-products", verifyAuth, requireRole("Admin"), async (req, res) => {
    try {
  ...
  router.delete("/ppf-products/:id", verifyAuth, requireRole("Admin"), async (req, res) => {
    try {
  ...
  router.post("/ppf-rolls", verifyAuth, requireRole("Admin"), async (req, res) => {
    try {
  ...
  router.patch("/ppf-rolls/:id", verifyAuth, requireRole("Admin"), async (req, res) => {
    try {
  ...
  router.delete("/ppf-rolls/:id", verifyAuth, requireRole("Admin"), async (req, res) => {
    try {
