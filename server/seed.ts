  ...
  try {
    ...
    if (existingUsers.length === 0) {
      ...
      await db.insert(users).values([
        ...
        { username: "sameer", password: hashedPassword, name: "Sameer", role: "Installer" },
        { username: "priya", password: hashedPassword, name: "Priya", role: "Installer" },
        { username: "vikram", password: hashedPassword, name: "Vikram", role: "Installer" },
      ]);
